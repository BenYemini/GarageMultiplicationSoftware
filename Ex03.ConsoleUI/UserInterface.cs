...
{
    // This is where we write and read to and from the user.
    
    // This class talks to no one! only returns to HandleIO.
    public class UserInterface
    {
        ...
        public static string GetFuelType(Dictionary<int, eFuelType> i_FuelTypes)
        {
            string fuelChoise = "";

            System.Console.WriteLine("Here are the options to choose from, please type the integer of a valid option:");
            foreach (var option in i_FuelTypes)
            {
                Console.WriteLine($"{option.Key}: {option.Value}");
            }

            fuelChoise = System.Console.ReadLine();
        ...
        public static string GetVehicleTypeFromUser(Dictionary<int, eVehicleType> i_VehicleTypes)
        {
            string vehicleChoise = "";

            System.Console.WriteLine("Here are the options to choose from, please type the integer of a valid option:");
            foreach (var option in i_VehicleTypes)
            {
                Console.WriteLine($"{option.Key}: {option.Value}");
            }

            vehicleChoise = System.Console.ReadLine();

            return vehicleChoise;
        }
